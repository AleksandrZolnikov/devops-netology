...
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl create serviceaccount netology
serviceaccount/netology created
```

##### Как просмотреть список сервис-акаунтов?  
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl get serviceaccounts
NAME       SECRETS   AGE
default    1         22m
netology   1         80s
```
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl get serviceaccount netology
NAME       SECRETS   AGE
netology   1         118s
```
...
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl get serviceaccount netology -o yaml
apiVersion: v1
kind: ServiceAccount
metadata:
  creationTimestamp: "2022-09-08T18:22:36Z"
  name: netology
  namespace: default
...
```
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl get serviceaccount default -o json
{
    "apiVersion": "v1",
    "kind": "ServiceAccount",
    "metadata": {
        "creationTimestamp": "2022-09-08T18:01:06Z",
        "name": "default",
        "namespace": "default",
        "resourceVersion": "412",
...
Вывод обрезал.  
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl get serviceaccount -o json > serviceaccount.json
aleksandr@WS01:~/14.04-serviceaccounts$ cat serviceaccount.json
{
    "apiVersion": "v1",
    "items": [
        {
...
```
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl get serviceaccount netology -o yaml > netology.yml
aleksandr@WS01:~/14.04-serviceaccounts$ cat netology.yml
apiVersion: v1
kind: ServiceAccount
metadata:
  creationTimestamp: "2022-09-08T18:22:36Z"
...
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl delete serviceaccount netology
serviceaccount "netology" deleted
```

##### Как загрузить сервис-акаунт из файла?  
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl apply -f netology.yml
serviceaccount/netology created
```
...
```
aleksandr@WS01:~/14.04-serviceaccounts$ kubectl run -i --tty fedora --image=fedora --restart=Never -- sh
