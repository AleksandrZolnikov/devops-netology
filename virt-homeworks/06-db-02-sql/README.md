...
```
aleksandr@aleksandr-VirtualBox:~/netology$ docker run -v /home/aleksandr/netology/data:/var/lib/postgresql/data -v /home/aleksandr/netology/backup:/var/lib/postgresql/backup -e POSTGRES_PASSWORD=mysecret -d postgres:12
```
...
12.00 -- приблизительная общая стоимость. 
...
# Остановите контейнер с PostgreSQL (но не удаляйте volumes).
docker stop 5a016fde5304

# Поднимите новый пустой контейнер с PostgreSQL.
docker run -v /home/aleksandr/netology/data:/var/lib/postgresql/data -v /home/aleksandr/netology/backup:/var/lib/postgresql/backup -e POSTGRES_PASSWORD=mysecret -d postgres:12

# Восстановите БД test_db в новом контейнере.
docker exec -it d66cb6f83a92 /bin/bash

#восстанавливаем БД из бэкапа
d66cb6f83a92:/# psql -U postgres -f /var/lib/postgresql/backup/test_db.sql
SET
SET
SET
SET
